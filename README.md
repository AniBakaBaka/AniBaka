...
**Q: 为什么不开源？**
A: 还没想好是否开源，主要是代码库太乱了，还有一些历史原因，所以闭源比开源的风险小一些。后续star高些后可能会考虑开源。建议某些开发者这辈子可不要用AI来编写界面，您的界面确实手搓好看，我到处抄抄就可以实现这么多源，而且还能解决某些源需要验证码的问题，好奇怪啊，怎么光抄就可以解决这个问题啊，据我所知目前AI还是喜欢用md3风格的。
